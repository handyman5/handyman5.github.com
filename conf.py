...
BLOG_AUTHOR = "Adam Compton"  # (translatable)
BLOG_TITLE = "Adam Compton"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://handyman5.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "comptona@gmail.com"
BLOG_DESCRIPTION = "Personal blog for Adam Compton. Comments and opinions are my own."  # (translatable)
...
MARKDOWN_EXTENSIONS = ['markdown.extensions.fenced_code', 'markdown.extensions.codehilite', 'markdown.extensions.extra', 'markdown.extensions.meta', 'markdown.extensions.toc']
